        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center">
            <a href="index.html" class="app-brand-link gap-2">
              ...
              <span class="app-brand-text demo text-body fw-bold m_title">Gestion des notes</span>
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-2">Bienvenue à la platforme de gestion des notes! 👋</h4>
...
<form id="formAuthentication" class="mb-3" action="login" method="post">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="username" name="username" placeholder="Entrez votre nom d'utilisateur" autofocus required />
  </div>
